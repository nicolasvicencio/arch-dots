...
case $base_res in 
  ...
  * )
     ...
     echo -e "\n Installing packages..."
     yay -S anki bitwarden discord vivaldi qbittorrent spotify spotify-adblock obsidian lib32-gamemode planify
